...
for i in {1..100}
do
    strace -o logs/logmodel_00/pymodel_00_$i.log -e trace=read python3.6 pymodel_00.py
    rm -rf pymodel_00_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_00 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_01/pymodel_01_$i.log -e trace=read python3.6 pymodel_01.py
    rm -rf pymodel_01_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_01 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_02/pymodel_02_$i.log -e trace=read python3.6 pymodel_02.py
    rm -rf pymodel_02_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_02 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_03/pymodel_03_$i.log -e trace=read python3.6 pymodel_03.py
    rm -rf pymodel_03_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_03 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_04/pymodel_04_$i.log -e trace=read python3.6 pymodel_04.py
    rm -rf pymodel_04_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_04 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_05/pymodel_05_$i.log -e trace=read python3.6 pymodel_05.py
    rm -rf pymodel_05_out.csv
    echo 3 > /proc/sys/vm/drop_caches
    date +"%c| pymodel_05 is done & pagecache, dentries and inodes is freed."
    strace -o logs/logmodel_06/pymodel_06_$i.log -e trace=read python3.6 pymodel_06.py
